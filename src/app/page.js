...
export default function Home() {
  ...
  <section >
    <h1 className=" text-xl md:text-5xl mt-3 italic  tracking-tight font-extrabold py-2 text-transparent bg-[url('/imgs/heading.jpg')] bg-cover bg-bottom bg-clip-text">Ricentra Blogs</h1>
